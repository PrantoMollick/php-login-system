    ...
    <div class="uk-section uk-container">
        <div class="uk-grid uk-child-width-1-3@s uk-child-width-1-1" uk-grid="">
            <form class="uk-form-stacked js-login">
                ...
                <div class="uk-margin">
                    <label class="uk-form-label" for="form-horizontal">Email</label>
                    <div class="uk-form-controls">
                        <input class="uk-input" id="form-horizontal" type="password" required="required" placeholder="Enter your password">
                    </div>
                </div>
